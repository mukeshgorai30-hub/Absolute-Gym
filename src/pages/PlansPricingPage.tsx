    ...
    <div className="w-full min-h-screen bg-neutral-950 text-white pt-6 pb-24">
          ...
          <div className="mt-8 flex items-center justify-center">
            <div className="inline-flex items-center p-1.5 rounded-2xl bg-neutral-900 border border-neutral-800 shadow-xl">
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-xs sm:text-sm font-black uppercase tracking-wider transition-all flex items-center gap-2 ${
                  activeTab === 'packages'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {activeTab === 'packages' ? (
          ...
          /* Spa & Massage Services Grid */
          <div className="bg-neutral-900/80 border border-neutral-800 rounded-3xl p-6 sm:p-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 text-cyan-400 text-xs font-black uppercase tracking-wider mb-2">
                  ...
                  <span>Hydrotherapy, Massage & Thermal Recovery</span>
                </div>
                <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-white">
                  Massage & Steam Recovery
                </h2>
                <p className="text-xs sm:text-sm text-neutral-400 mt-1 max-w-2xl">
                  Recharge your body with our Finnish cedar saunas, eucalyptus aroma steam, deep tissue massage, and clinical physiotherapy.
                </p>
              </div>
              <button
                onClick={() => setIsTrialModalOpen(true)}
                className="px-5 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-xs font-black text-black transition shrink-0 uppercase tracking-wider"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {spaServices.map((spa: SpaServiceItem) => (
                <div
                  key={spa.id}
                  className="bg-neutral-950 border border-neutral-800 hover:border-neutral-700 rounded-2xl p-6 flex flex-col justify-between transition-all shadow-xl"
                >
                  <div>
                    <div className="flex items-center justify-between text-xs text-neutral-400 mb-2">
                      <span className="font-bold text-cyan-400 uppercase text-[10px] bg-cyan-950/60 px-2 py-0.5 rounded border border-cyan-800/40">
                        {spa.category}
                      </span>
                    ...
                    <h4 className="text-lg font-black uppercase text-white mt-2">{spa.name}</h4>
                    <p className="text-xs text-neutral-400 mt-2 leading-relaxed">{spa.description}</p>
                  </div>

                  <div className="mt-6 pt-4 border-t border-neutral-800 flex items-baseline justify-between">
                    <div>
                      <span className="text-[10px] uppercase text-neutral-500 block font-bold">Member Rate</span>
